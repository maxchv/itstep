...
известные со школьного курса математики.

Но не все стандартные математические символы возможно применять.
Это связано с отсутствием соответствующих символов на стандартной клавиатуре.
...
* `Notes about booleans and logical operators`_

.. _Notes about booleans and logical operators: http://www.thomas-cokelaer.info/tutorials/python/boolean.html
